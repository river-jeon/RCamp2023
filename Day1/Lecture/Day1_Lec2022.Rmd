...
# Rmd: R Markdown 
- magic book where you can write words, add pictures, and do math to tell a story with data.
  - R Markdown is a file format that combines markdown (a lightweight markup language for creating formatted text) with embedded R code chunks. 
  - It has a .Rmd extension. 
  - main purpose of R Markdown is to create dynamic documents, reports, presentations, and even websites. It allows for the integration of R code with narrative text, images, and other elements.
  - Interactivity: R Markdown documents are processed through the knitr package in R, which runs the embedded R code and inserts results (like plots, tables, and computed values) directly into the document. 
  - R Markdown supports the creation of well-structured, publication-quality documents, including PDFs, HTML pages, and slideshows. 
  - It's ideal for data analysis reports, presentations, and scientific papers where you need to combine statistics, graphs, and text. 
...
[https://github.com/river-jeon/RCamp2023](https://github.com/river-jeon/RCamp2023)
...
<p>
![RStudio download page](/Users/river/Documents/GitHub/RCamp2023/Day1/Lecture/pics/Install6.png){width=70%}
</p>
<p>
![Download RStudio Desktop (free version)](/Users/river/Documents/GitHub/RCamp2023/Day1/Lecture/pics/Install7.png){width=70%}
</p>
<p>
![Choose the one for your OS](/Users/river/Documents/GitHub/RCamp2023/Day1/Lecture/pics/Install8.png){width=70%}
</p>
<p>
...
together with c():
"An atomic vector in R is like a train with cars in a line, where each car holds one piece of information, like a number or a word. You can make an atomic vector by putting together different pieces of data with `c()`. For example, if you put the numbers 1, 2, 3, 4, 5, 6 into `c()`, you get a train of numbers, which is an atomic vector"
```{r}
# die1 <- 1:6 # "integer"
# die1

die <- c(1, 2, 3, 4, 5, 6) # "double" (real number)
die
...
complex (i.e., complex numbers, e.g., imaginary), and raw (i.e., raw bytes, e.g.,
dealing with binary numbers directly)."
...
# 31 == ASCII: 49 (hexadecimal: 31)
# 0 == ASCII: 48 (hexadecimal: 30)
# charToRaw("10") 
...
typeof(die) # "double" (double-precision floating-point numbers)

# NOT the same as die <- 1:6
# die1 <- 1:6 # typeof(die1) == "integer"
# die1
```
...
# cannot store infinite length of decimal points, approximation
sqrt(2)^2 - 2 == 0
sqrt(2)^2 - 2

# # check tolerance
# tolerance <- 1e-10
# abs(sqrt(2)^2 - 2) < tolerance

# as.integer(3.9) # round down
# round(3.9) # round 
...
# as.logical(0) # 0 converts to TRUE
# as.logical(10) # other number converts to FALSE
```
