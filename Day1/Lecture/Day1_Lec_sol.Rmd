...
* R has over 10,000+ contributing packages. This makes it possible to do almost everything you need.
...
<p>
![The R Project for Statistical Computing](/Users/ysui/Desktop/R_Camp/Day1/pics/Install1.png){width=70%}
</p>

<p>
![CRAN Mirrors](/Users/ysui/Desktop/R_Camp/Day1/pics/Install2.png){width=70%}
</p>
<p>
![Choose your OS](/Users/ysui/Desktop/R_Camp/Day1/pics/Install3.png){width=70%}
</p>
<p>
![macOS download](/Users/ysui/Desktop/R_Camp/Day1/pics/Install4.png){width=70%}
</p>
<p>
![Windows download](/Users/ysui/Desktop/R_Camp/Day1/pics/Install5.png){width=70%}
</p>
...
<p>
![RStudio download page](/Users/ysui/Desktop/R_Camp/Day1/pics/Install6.png){width=70%}
</p>
<p>
![Download RStudio Desktop (free version)](/Users/ysui/Desktop/R_Camp/Day1/pics/Install7.png){width=70%}
</p>
<p>
![Choose the one for your OS](/Users/ysui/Desktop/R_Camp/Day1/pics/Install8.png){width=70%}
</p>
<p>
![R Studio Overview](/Users/ysui/Desktop/R_Camp/Day1/pics/RStudio.png){width=70%}
</p>
...
> 
# Here the user is trying to do modulus in R, but fails to use the correct operator for modulus %%. 
```
...
When you create an object, the object will appear in the environment pane (upper right) of RStudio.
...
Don’t worry if you’re not familiar with these operations. They are easy to look up. R offers a help() function that you can use when you encounter unfamiliar operators, functions, pacakges, etc. You can also use the shortcut "?" symbol to do the same. 
...
5. Add one the odd elements in numbers (e.g. 1,3,5,7,9...), and add two to the even elements in numbers. Store the new sequence in a new object named "numbers3".
...
Do you need to build a data set from scratch to use it in R? Not at all. In Day 2's lecture content we will cover loading data sets into R with on simple step. 
...
typeof(text)
typeof("Biden")
# The maximum value (also used as default) that can be set is 65535. Strings longer than that will be truncated.
# which means you will rarely run out of space to store character strings. 
```
...
To do this, set the dim attribute to a numeric vector of length n. R will reorganize the elements of the vector into n dimensions. Each dimension will have as many rows or columns as the nth value of the dim vector. For example, you can reorganize die into a 2 × 3 matrix (which has 2 rows and 3 columns):
```{r}
dim(die) <-c(2, 3)
die
```
...
```{r}
# In the following example, the first element of the list is a character vector (of length 1). 
# The second element is also a character vector, and the third element is a numeric vector:
